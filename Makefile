...
OBJS		= kernel/kernel.o kernel/start.o kernel/main.o\
			...
			fs/main.o fs/open.o fs/misc.o fs/read_write.o fs/mlls.o\
			fs/link.o \
			fs/disklog.o \
			fs/mlopen.o fs/mllink.o\
			command/hi.o command/calendar.o\
			lib/adduser.o lib/editappand.o lib/editcover.o\
			lib/mlls.o lib/getdirlevel.o
LOBJS		=  lib/syscall.o\
			lib/printf.o lib/vsprintf.o lib/vsscanf.o lib/scanf.o\
			...
			lib/get_tty_name.o lib/do_tty_cache.o lib/selectcon.o\
			lib/mlopendir.o lib/mlopenfile.o\
			lib/unmllink.o lib/conf_dir.o\
			lib/getprotable.o lib/killproc.o\
			lib/char2int.o
...
lib/selectcon.o: lib/selectcon.c
	$(CC) $(CFLAGS) -o $@ $<

lib/vsprintf.o: lib/vsprintf.c
	$(CC) $(CFLAGS) -o $@ $<

lib/getdirlevel.o: lib/getdirlevel.c
	$(CC) $(CFLAGS) -o $@ $<
...
lib/adduser.o : lib/adduser.c
	$(CC) $(CFLAGS) -o $@ $<

lib/editappand.o : lib/editappand.c
	$(CC) $(CFLAGS) -o $@ $<

lib/editcover.o : lib/editcover.c
	$(CC) $(CFLAGS) -o $@ $<
...
lib/getprotable.o: lib/getprotable.c
	$(CC) $(CFLAGS) -o $@ $<

lib/killproc.o: lib/killproc.c
	$(CC) $(CFLAGS) -o $@ $<
...
fs/mlopen.o: fs/mlopen.c
	$(CC) $(CFLAGS) -o $@ $<

fs/mllink.o: fs/mllink.c
	$(CC) $(CFLAGS) -o $@ $<

fs/mlls.o: fs/mlls.c
	$(CC) $(CFLAGS) -o $@ $<

lib/mlopenfile.o: lib/mlopenfile.c
	$(CC) $(CFLAGS) -o $@ $<

lib/mlopendir.o: lib/mlopendir.c
	$(CC) $(CFLAGS) -o $@ $<

lib/unmllink.o: lib/unmllink.c
	$(CC) $(CFLAGS) -o $@ $<

lib/get_tty_name.o: lib/get_tty_name.c
	$(CC) $(CFLAGS) -o $@ $<

lib/do_tty_cache.o: lib/do_tty_cache.c
	$(CC) $(CFLAGS) -o $@ $<

lib/conf_dir.o: lib/conf_dir.c
	$(CC) $(CFLAGS) -o $@ $<

lib/scanf.o: lib/scanf.c
	$(CC) $(CFLAGS) -o $@ $<

lib/vsscanf.o: lib/vsscanf.c
	$(CC) $(CFLAGS) -o $@ $<
